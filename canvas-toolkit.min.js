ctk.Area=function(){this.CoordinateSystem="screen";this.y1=this.x1=this.y0=this.x0=0;this.width=function(){return this.x1-this.x0+1};this.height=function(){return this.y1-this.y0+1}};
ctk.AreaMap=function(){this.SourceArea=new ctk.Area;this.TargetArea=new ctk.Area;this.MapX=function(a){a=(a-this.SourceArea.x0)/(this.SourceArea.x1-this.SourceArea.x0);return a=this.TargetArea.x0+a*(this.TargetArea.x1-this.TargetArea.x0)};this.MapY=function(a){a=(a-this.SourceArea.y0)/(this.SourceArea.y1-this.SourceArea.y0);this.SourceArea.CoordinateSystem!==this.TargetArea.CoordinateSystem&&(a=1-a);return a=this.TargetArea.y0+a*(this.TargetArea.y1-this.TargetArea.y0)};this.UnmapX=function(a){a=(a-
this.TargetArea.x0)/(this.TargetArea.x1-this.TargetArea.x0);return a=this.SourceArea.x0+a*(this.SourceArea.x1-this.SourceArea.x0)};this.UnmapY=function(a){a=(a-this.TargetArea.y0)/(this.TargetArea.y1-this.TargetArea.y0);this.SourceArea.CoordinateSystem!==this.TargetArea.CoordinateSystem&&(a=1-a);return a=this.SourceArea.y0+a*(this.SourceArea.y1-this.SourceArea.y0)}};ctk.Canvas=function(){this.Context=this.Canvas=null;this.ClearRect=function(a,b,c,d){return this.Context.clearRect(a,b,c,d)};this.FillRect=function(a,b,c,d){return this.Context.fillRect(a,b,c,d)};this.StrokeRect=function(a,b,c,d){return this.Context.strokeRect(a,b,c,d)};this.FillText=function(a,b,c,d){return this.Context.fillText(a,b,c,d)};this.StrokeText=function(a,b,c,d){return this.Context.strokeText(a,b,c,d)};this.MeasureText=function(a){return this.Context.measureText(a)};this.BeginPath=function(){return this.Context.beginPath()};
this.ClosePath=function(){return this.Context.closePath()};this.MoveTo=function(a,b){return this.Context.moveTo(a,b)};this.LineTo=function(a,b){return this.Context.lineTo(a,b)};this.BezierCurveTo=function(a,b,c,d,e,f){return this.Context.bezierCurveTo(a,b,c,d,e,f)};this.QuadraticCurveTo=function(a,b,c,d){return this.Context.quadraticCurveTo(a,b,c,d)};this.Arc=function(a,b,c,d,e,f){return this.Context.arc(a,b,c,d,e,f)};this.ArcTo=function(a,b,c,d,e){return this.Context.arcTo(a,b,c,d,e)};this.Rect=
